WITH /* pgwatch2_generated */ q_data AS (
    SELECT
        ...
        round(sum(shared_blk_read_time)::numeric, 3)::double precision AS blk_read_time,
        round(sum(shared_blk_write_time)::numeric, 3)::double precision AS blk_write_time,
